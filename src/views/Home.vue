...
.search-language-input {
  .v-input__slot {
    background-color: #2d172c !important;
  }
}

.language-card-focus {
  outline: 2px solid #ec964b;
}
.language-card-blur {
  outline: 2px solid rgb(239, 99, 99);
}

.close-button-focus {
  border: 2px solid #79ed56 !important;
}

.close-button-blur {
  border: 2px solid rgb(230, 77, 77) !important;
}
